 ...
 */
var r;r=function(){return function(e){var u={};function t(r){if(u[r])return u[r].exports;var a=u[r]={exports:{},id:r,loaded:!1};return e[r].call(a.exports,a,a.exports,t),a.loaded=!0,a.exports}return t.m=e,t.c=u,t.p="",t(0)}([function(e,u,t){"use strict";var r=function(){function e(e,u){for(var t=0;t<u.length;t++){var r=u[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(u,t,r){return t&&e(u.prototype,t),r&&e(u,r),u}}();var a=t(1).Pangu,n=function(e){function u(){!function(e,u){if(!(e instanceof u))throw new TypeError("Cannot call a class as a function")}(this,u);var e=function(e,u){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!u||"object"!=typeof u&&"function"!=typeof u?e:u}(this,Object.getPrototypeOf(u).call(this));return e.topTags=/^(html|head|body|#document)$/i,e.ignoreTags=/^(script|code|pre|textarea)$/i,e.spaceSensitiveTags=/^(a|del|pre|s|strike|u)$/i,e.spaceLikeTags=/^(br|hr|i|img|pangu)$/i,e.blockTags=/^(div|h1|h2|h3|h4|h5|h6|p)$/i,e}return function(e,u){if("function"!=typeof u&&null!==u)throw new TypeError("Super expression must either be null or a function, not "+typeof u);e.prototype=Object.create(u&&u.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),u&&(Object.setPrototypeOf?Object.setPrototypeOf(e,u):e.__proto__=u)}(u,a),r(u,[{key:"canIgnoreNode",value:function(e){for(var u=e.parentNode;u&&u.nodeName&&-1===u.nodeName.search(this.topTags);){if(u.nodeName.search(this.ignoreTags)>=0||u.isContentEditable||"true"===u.getAttribute("g_editable"))return!0;u=u.parentNode}return!1}},{key:"isFirstTextChild",value:function(e,u){for(var t=e.childNodes,r=0;r<t.length;r++){var a=t[r];if(8!==a.nodeType&&a.textContent)return a===u}return!1}},{key:"isLastTextChild",value:function(e,u){for(var t=e.childNodes,r=t.length-1;r>-1;r--){var a=t[r];if(8!==a.nodeType&&a.textContent)return a===u}return!1}},{key:"spacingNodeByXPath",value:function(e,u){for(var t=document.evaluate(e,u,null,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE,null),r=void 0,a=void 0,n=t.snapshotLength-1;n>-1;--n)if(r=t.snapshotItem(n),this.canIgnoreNode(r))a=r;else{var f=this.spacing(r.data);if(r.data!==f&&(r.data=f),a){if(r.nextSibling&&r.nextSibling.nodeName.search(this.spaceLikeTags)>=0){a=r;continue}var o=r.data.toString().substr(-1)+a.data.toString().substr(0,1);if(this.spacing(o)!==o){for(var i=a;i.parentNode&&-1===i.nodeName.search(this.spaceSensitiveTags)&&this.isFirstTextChild(i.parentNode,i);)i=i.parentNode;for(var c=r;c.parentNode&&-1===c.nodeName.search(this.spaceSensitiveTags)&&this.isLastTextChild(c.parentNode,c);)c=c.parentNode;if(c.nextSibling&&c.nextSibling.nodeName.search(this.spaceLikeTags)>=0){a=r;continue}if(-1===c.nodeName.search(this.blockTags))if(-1===i.nodeName.search(this.spaceSensitiveTags))-1===i.nodeName.search(this.ignoreTags)&&-1===i.nodeName.search(this.blockTags)&&(a.previousSibling?-1===a.previousSibling.nodeName.search(this.spaceLikeTags)&&(a.data=" "+a.data):this.canIgnoreNode(a)||(a.data=" "+a.data));else if(-1===c.nodeName.search(this.spaceSensitiveTags))r.data=r.data+" ";else{var s=document.createElement("pangu");s.innerHTML=" ",i.previousSibling?-1===i.previousSibling.nodeName.search(this.spaceLikeTags)&&i.parentNode.insertBefore(s,i):i.parentNode.insertBefore(s,i),s.previousElementSibling||s.parentNode&&s.parentNode.removeChild(s)}}}a=r}}},{key:"spacingNode",value:function(e){this.spacingNodeByXPath(".//*/text()[normalize-space(.)]",e)}},{key:"spacingElementById",value:function(e){var u='id("'+e+'")//text()';this.spacingNodeByXPath(u,document)}},{key:"spacingElementByClassName",value:function(e){var u='//*[contains(concat(" ", normalize-space(@class), " "), "'+e+'")]//text()';this.spacingNodeByXPath(u,document)}},{key:"spacingElementByTagName",value:function(e){var u="//"+e+"//text()";this.spacingNodeByXPath(u,document)}},{key:"spacingPageTitle",value:function(){this.spacingNodeByXPath("/html/head/title/text()",document)}},{key:"spacingPageBody",value:function(){for(var e="/html/body//*/text()[normalize-space(.)]",u=["script","style","textarea"],t=0;t<u.length;t++){e+='[translate(name(..),"ABCDEFGHIJKLMNOPQRSTUVWXYZ","abcdefghijklmnopqrstuvwxyz")!="'+u[t]+'"]'}this.spacingNodeByXPath(e,document)}},{key:"spacingPage",value:function(){this.spacingPageTitle(),this.spacingPageBody()}}]),u}(),f=new n;(e.exports=f).Pangu=n},function(e,u){"use strict";var t=function(){function e(e,u){for(var t=0;t<u.length;t++){var r=u[t];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(u,t,r){return t&&e(u.prototype,t),r&&e(u,r),u}}();var r=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])(["])/g,a=/(["])([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])/g,n=/(["']+)(\s*)(.+?)(\s*)(["']+)/g,f=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])( )(')([A-Za-z])/g,o=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])(#)([A-Za-z0-9\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff]+)(#)([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])/g,i=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])(#([^ ]))/g,c=/(([^ ])#)([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])/g,s=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])([\+\-\*\/=&\\|<>])([A-Za-z0-9])/g,l=/([A-Za-z0-9])([\+\-\*\/=&\\|<>])([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])/g,p=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])([\(\[\{<\u201c]+(.*?)[\)\]\}>\u201d]+)([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])/g,d=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])([\(\[\{<\u201c>])/g,h=/([\)\]\}>\u201d<])([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])/g,g=/([\(\[\{<\u201c]+)(\s*)(.+?)(\s*)([\)\]\}>\u201d]+)/,b=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])([~!;:,\.\?\u2026])([A-Za-z0-9])/g,m=/([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])([A-Za-z0-9`\$%\^&\*\-=\+\\\|\/@\u00a1-\u00ff\u2022\u2027\u2150-\u218f])/g,y=/([A-Za-z0-9`~\$%\^&\*\-=\+\\\|\/!;:,\.\?\u00a1-\u00ff\u2022\u2026\u2027\u2150-\u218f])([\u2e80-\u2eff\u2f00-\u2fdf\u3040-\u309f\u30a0-\u30ff\u3100-\u312f\u3200-\u32ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff])/g,v=function(){function e(){!function(e,u){if(!(e instanceof u))throw new TypeError("Cannot call a class as a function")}(this,e)}return t(e,[{key:"spacing",value:function(e){var u=e,t=u=(u=(u=(u=(u=(u=(u=(u=(u=u.replace(r,"$1 $2")).replace(a,"$1 $2")).replace(n,"$1$3$5")).replace(f,"$1$3$4")).replace(o,"$1 $2$3$4 $5")).replace(i,"$1 $2")).replace(c,"$1 $3")).replace(s,"$1 $2 $3")).replace(l,"$1 $2 $3"),v=u.replace(p,"$1 $2 $4");return u=v,t===v&&(u=(u=u.replace(d,"$1 $2")).replace(h,"$1 $2")),u=(u=(u=(u=u.replace(g,"$1$3$5")).replace(b,"$1$2 $3")).replace(m,"$1 $2")).replace(y,"$1 $2")}},{key:"spacingText",value:function(e){var u=arguments.length<=1||void 0===arguments[1]?function(){}:arguments[1];try{u(null,this.spacing(e))}catch(e){u(e)}}}]),e}(),S=new v;(e.exports=S).Pangu=v}])},e.exports=r()},function(e,u,t){"use strict";Object.defineProperty(u,"__esModule",{value:!0});var r=t(5);u.CopyWritingCorrectService=r.CopyWritingCorrectService;var a=t(0);u.CharacterCorrector=a.default;var n=t(2);u.ProperNounsCorrector=n.default;var f=t(3);u.SpaceCorrector=f.default;var o,i=t(4);u.UnitOfMeasurementCorrector=i.default,u.default=r.CopyWritingCorrectService,(o="object"==typeof window?window:this).CopyWritingCorrectService=r.CopyWritingCorrectService,o.CopyWritingCorrectors={CharacterCorrector:a.default,SpaceCorrector:f.default,ProperNounsCorrector:n.default,UnitOfMeasurementCorrector:i.default}}])});